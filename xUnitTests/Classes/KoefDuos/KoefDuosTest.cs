...
namespace xUnitTests.Classes.KoefDuos
{
    public class KoefDuosTest
    {
        ...
        public void KreirajNoviUnosBojan(string imeFajlaStari, string imeFajlaNovi)
        {
            ...
            string strNoviUnos = JISP.Classes.KoefDuos.KoefDuos.KreirajNoviUnos(strStariUnos, novaGodina, noviMesec);
        ...
        public void DobijanjeJsonStringaOdBashKomande()
        {
            ...
            string strJson = JISP.Classes.KoefDuos.KoefDuos.Bash2Json(strBash);
